...
export interface DaemonSessionEvent {
  ...
  type:
    ...
    | 'POSITION_CLOSED'
    | 'EMERGENCY_FLATTEN'
    | 'SPARK_DECISION_STAGED'
    | 'SPARK_DECISION_STANDBY'
    | 'SPARK_DECISION_PAPER_QUEUED'
    | 'SPARK_DECISION_PAPER_FILLED'
    | 'SPARK_DECISION_TP1_HARVEST'
    | 'SPARK_DECISION_PAPER_CLOSED'
    | 'SPARK_DECISION_EXECUTED'
    | 'SPARK_DECISION_INVALIDATED'
    | 'SPARK_DECISION_REJECTED'
    | 'SPARK_DECISION_STAND_DOWN'
    | 'SPARK_DECISION_DUPLICATE_SUPPRESSED'
