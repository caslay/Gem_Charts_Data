...
export const FACTORY_SWEEP_RECLAIM_PRESETS: ScannerPreset[] = [
  {
    ...
    description: 'The 1-Year Validated Institutional All-Time Champion (+223.8R Net Realized Return, 1.75 PF, -6.68R Max DD, +7,328% Compounded Return from $1k to $74,287 with only 12.9% Max DD, 14/14 Winning Months). Enters at FVG 50% Consequent Encroachment (CE) with purified Swing Pivots + Daily anchors, 1.10x Volume expansion, 15-bar TTL, 60% TP1 @ 1.0R / 40% TP2 @ 1.30R, and Rule 4 Early Breakeven (+0.40R).',
  ...
  },
  {
    ...
    name: '5m Sweep & Reclaim Alpha Shield V2 (Capital Preservation)',
    description: 'The 1-Year Validated Low-Drawdown Capital Shield Champion (+206.8R Net Realized Return, 1.70 PF, ultra-low -5.75R Max DD, 11.3% Compounded DD, +5,182% Compounded Return from $1k to $52,821, 14/14 Winning Months). Enters at FVG 50% CE with Swing Pivots + Daily anchors, 1.10x Volume, 15-bar TTL, 50% TP1 @ 1.0R / 50% TP2 @ 1.50R, and Rule 4 Early Breakeven (+0.40R).',
    strategyType: 'SWEEP_RECLAIM',
    symbol: 'ETHUSDC',
    timeframe: '5m',
    isFactory: true,
