...
async function main() {
  ...
  console.log('🔬 PHASE 2: COMBINATION & MULTI-MONTH AUDIT');
  console.log('═'.repeat(100));
  ...
  const candidates = [
    {
      ...
      name: 'Original Benchmark (Vol 1.20x | All Anchors)',
      cfg: { ...baseChampionConfig, volumeExpansionThreshold: 1.20 },
    },
    {
      id: 'PHASE1_WINNER',
      name: 'Phase 1 Winner (Vol 1.10x | All Anchors)',
      cfg: { ...baseChampionConfig },
    },
    {
      id: 'PHASE2_PIVOTS_ONLY',
      name: 'EXP-P2-01B (Vol 1.10x | Swing Pivots + Daily)',
      cfg: { ...baseChampionConfig, anchorTypes: pivotOnlyAnchors },
    },
    {
      id: 'PHASE2_PIVOTS_RETEST15',
      name: 'EXP-P2-HYBRID-A (Pivots + Daily | Retest 15 bars)',
      cfg: { ...baseChampionConfig, anchorTypes: pivotOnlyAnchors, maxBarsToRetest: 15 },
    },
    {
      id: 'PHASE2_PIVOTS_BODY0.50',
      name: 'EXP-P2-HYBRID-B (Pivots + Daily | Body 0.50)',
      cfg: { ...baseChampionConfig, anchorTypes: pivotOnlyAnchors, bodyRatioThreshold: 0.50 },
    },
    {
      id: 'PHASE2_PIVOTS_BODY0.50_RETEST15',
      name: 'EXP-P2-HYBRID-C (Pivots + Daily | Body 0.50 | Retest 15)',
      cfg: { ...baseChampionConfig, anchorTypes: pivotOnlyAnchors, bodyRatioThreshold: 0.50, maxBarsToRetest: 15 },
    },
  ];
  ...
  for (const c of candidates) {
    ...
    console.log(`Monthly Consistency: ${months.length - losingMonths}/${months.length} Winning Months (${losingMonths} losing months)`);
  }
}
