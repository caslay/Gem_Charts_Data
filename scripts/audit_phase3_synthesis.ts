...
async function main() {
  ...
  console.log('🔬 PHASE 3: HARVEST SYNTHESIS & REGIME AUDIT');
  console.log('═'.repeat(100));
  ...
  const candidates = [
    {
      ...
      name: 'Original Benchmark (Vol 1.2x | All Anchors | TP2 1.4R | 50/50)',
      cfg: {
        ...baseConfig,
    ...
    {
      id: 'PHASE2_CHAMPION',
      name: 'Phase 2 Champion (Vol 1.1x | Pivots+Daily | Retest 15 | TP2 1.4R | 50/50)',
      cfg: { ...baseConfig },
    },
    {
      id: 'SYNTHESIS_TP130_5050',
      name: 'Synthesis A: TP2 1.30R (50/50 split)',
      cfg: { ...baseConfig, stage2Multiple: 1.30 },
    },
    {
      id: 'SYNTHESIS_TP130_6040',
      name: 'Synthesis B: TP2 1.30R (60/40 split)',
      cfg: { ...baseConfig, stage2Multiple: 1.30, stage1Ratio: 0.60, stage2Ratio: 0.40 },
    },
    {
      id: 'SYNTHESIS_TP140_6040',
      name: 'Synthesis C: TP2 1.40R (60/40 split)',
      cfg: { ...baseConfig, stage2Multiple: 1.40, stage1Ratio: 0.60, stage2Ratio: 0.40 },
    },
    {
      id: 'SYNTHESIS_TP150_5050',
      name: 'Synthesis D: TP2 1.50R (50/50 split - Max DD focus)',
      cfg: { ...baseConfig, stage2Multiple: 1.50 },
    },
  ];
