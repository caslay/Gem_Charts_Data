...
exports.verifyDisplacementOffline = verifyDisplacementOffline;
exports.verifyDisplacement = verifyDisplacement;
function verifyDisplacementOffline(recentCandles, symbol = 'ETHUSDC') {
    ...
    let status = isConsolidation ? 'CONSOLIDATION' : 'INACTIVE';
...
async function verifyDisplacement(recentCandles, symbol = 'ETHUSDC') {
