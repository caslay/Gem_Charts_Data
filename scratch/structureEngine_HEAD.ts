 ...
 * Centralized Market Structure Analysis Engine ΓÇö SINGLE SOURCE OF TRUTH.
 *
...
// ΓöÇΓöÇΓöÇ Exported Interfaces ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export interface ZigZagSegment {
   ...
   *   BOS      ΓÇö Break of Structure (trend continuation)
   *   MSS      ΓÇö Market Structure Shift (trend reversal)
   *   INTERNAL ΓÇö First segment / insufficient context for classification
   */
...
function runEquilibriumStateMachine(
  ...
  // ΓöÇΓöÇΓöÇ Parent-Child Wave Containment Tagging ON CONFIRMED SWINGS ONLY ΓöÇΓöÇΓöÇ
...
export function analyzeMarketStructure(
  ...
  // ΓöÇΓöÇΓöÇ Velocity-Based Momentum Override ΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Stateful Caching Layer ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
