...
| :--- | :--- | :--- | :--- |
| **1. Exchange Credentials Injection** | Binance Futures API | Injected into `/home/ubuntu/quegar/.env.production` (Whitelisted to `57.181.64.238`, `AUTO_EXECUTE=false` standby mode). | 🟢 Injected & Verified (Standby) |
